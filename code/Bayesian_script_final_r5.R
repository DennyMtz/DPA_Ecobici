...
#	--------------------------------------------			
#REGION 5
X_r0 <- subset(dde_1, dde_1$region_5==1)
...
for(gt in 1:G){
  ...
  #	Output
  write(t(beta),file=paste(path_to_project,'results/R_5_beta.out',sep = ""), ncol=ncol(X), append=T)
  print(c(gt,round(beta*100)/100))
}

#	Trace-plots para beta[1] y beta[2]
#pdf(paste(path_to_project,'results/R_4_beta_traces.pdf',sep = ""),width=7,height=5)
# par(mfrow=c(2,1))
beta_out<- matrix(scan(paste(path_to_project,'results/R_5_beta.out',sep = "")), ncol=ncol(X), byrow=T)
# plot(beta_out[,1],type="l",xlab="iteration",ylab="(beta_1)")
# plot(beta_out[,2],type="l",xlab="iteration",ylab="(beta_2)")
#dev.off()

pdf(paste(path_to_project,'results/R_5_beta_traces_0.pdf',sep = ""),width=7,height=5)
par(mfrow=c(3,3))
...
pdf(paste(path_to_project,'results/R_5_beta_traces_1.pdf',sep = ""),width=7,height=5)
par(mfrow=c(3,3))
...
pdf(paste(path_to_project,'results/R_5_beta_traces_2.pdf',sep = ""),width=7,height=5)
par(mfrow=c(3,3))
...
print(betas_ok)
write.csv(betas_ok,file='../results/R_5_betas_finales.csv')

#	Distribucion final marginal
pdf(paste(path_to_project,'results/R5_density_1.pdf',sep = ""),width=7,height=5)
par(mfrow=c(3,3))
...
pdf(paste(path_to_project,'results/R5_density_2.pdf',sep = ""),width=7,height=5)
par(mfrow=c(3,3))
...
pdf(paste(path_to_project,'results/R5_density_3.pdf',sep = ""),width=7,height=5)
par(mfrow=c(3,3))
